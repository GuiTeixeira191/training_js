function converterCelcius() {
    ...
    document.getElementById('resultC').innerHTML = celcius + '°C é igual a ' + fahrenheight.toFixed(1) + ' °F '
}
...
function converterFahrenheight() {
    ...
    document.getElementById('resultF').innerHTML = fahrenheight + ' °F é igual a ' + celcius.toFixed(1) + ' °C '
}